    ...
    <main className="min-h-screen bg-gradient-to-b from-background to-secondary ">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <div className="text-center space-y-6 mb-12">
          <h1 className="text-2xl sm:text-4xl md:text-6xl font-bold bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent">
            Solana Token Lens
          </h1>
          ...
          <p className='text-muted-foreground text-xs sm:text-sm'>
            This tool use <a target='_blank' href='https://rugcheck.xyz/' className='text-black underline underline-offset-4 hover:text-gray-600 transition-all ease-in-out'>Rugcheck</a> api to fetch token data
          </p>
        ...
        <Card className="p-6 md:p-8 backdrop-blur-sm bg-card/50">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            ...
            <div className="p-4 rounded-lg bg-card border">
              <h3 className="font-semibold mb-2 text-sm sm:text-base">Risk Score</h3>
              <p className="text-xs sm:text-sm text-muted-foreground">
